...
layout = html.Div([
    ...
    html.Div([
        ...
        html.P(
            "En mayo de 2019, el Gobierno de la Ciudad de México, a través de la Secretaría de Educación, Ciencia, Tecnología e Innovación, dio un paso importante hacia la ampliación del acceso a la educación superior: la creación del Instituto de Estudios Superiores de la Ciudad de México “Rosario Castellanos” (IRC). Esta institución nació con la misión de formar profesionistas capaces de contribuir al desarrollo social y económico de la capital, con un modelo académico innovador, incluyente y de calidad. (La siguiente pestaña es la del CECATI, asi que cuando termines de leer continua con esa pestaña, gracias :3, )", className="animate-on-scroll", 
